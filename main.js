...
let quizdata = [
    [
        ...
        ['海上自衛隊で金曜日に必ず食べるものは？', ['A.鍋','B.カレー','C.肉じゃが','D.焼き魚'], 2, [[30,0],[50,0],[75,0],[100,0]], '📞海上生活をしていると、今日が何曜日かわからなくなりそう。'],
        ...
        ['ランニングマシンは当初何として発明されたか？', ['A.パンこね機','B.プレス機','C.刑罰器具','D.ライン工場のライン'], 3, [[5,0],[15,0],[55,0],[100,0]], '📞...'],
        ...
        ['次のうち、最も大きい酔いの度合いを表すものはどれ？', ['A.泥酔','B.昏睡','C.ほろ酔い','D.酩酊'], 4, [[30,0],[65,0],[70,0],[100,0]], '📞この状態になると、最悪死んでしまう。'],
